...
namespace SFML_Roguelike.Source.Game.Player
{
	...
	{
		public RLevel LevelRef { get; set; }
		private TVector2f MouseCoords { get; set; } = new TVector2f();
		public RTile CurrentlyHoveredTile { get; private set; }
		public RTile CurrentlySelectedTile { get; private set; }
		public TVector2i CurrentlyHoveredTileCoords { get; private set; }
		public TVector2i CurrentlySelectedTileCoords { get; private set; }

		public List<RNexus> PlayerNexus = new List<RNexus>();
		public uint Health
		{
			get
			{
		...
		public override void OnGameStart()
		{
			...
			PlayerNexus = LevelRef?.FindActorsInLevel<RNexus>().ToList();
		}
