...
namespace ZEngine.Engine.Graphics
{
	public class SpriteActor : PhysicsActor
	{
		...
		public SpriteActor(Sprite sprite) : base(PhysicsType.Rectangle, BodyType.Dynamic, 1.0f, new TVector2f(sprite.GetGlobalBounds().Width / 2.0f, sprite.GetGlobalBounds().Height / 2.0f), false, false, false)
		{
