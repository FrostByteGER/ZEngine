...
{
	public class RGameMode : GameMode
	{

		public RPlayerController Player { get; set; }
		...
		public List<RSpawner> Spawners { get; set; } = new List<RSpawner>();
		...
		protected override void OnGameStart()
		{
			...
			Spawners = LevelReference.FindActorsInLevel<RSpawner>().ToList();
